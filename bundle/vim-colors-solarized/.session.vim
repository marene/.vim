...
set noswapfile
set tabstop=2
set tags=~/.vim/bundle/vim-colors-solarized/.tags/tags
...
set shortmess=aoO
badd +0 colors/solarized.vim
badd +0 ~/.vimrc
argglobal
silent! argdel *
argadd colors/solarized.vim
edit ~/.vimrc
...
235
normal! zo
let s:l = 317 - ((20 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
317
